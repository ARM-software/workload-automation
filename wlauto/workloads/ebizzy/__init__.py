...
class Ebizzy(Workload):
    ...
    parameters = [
        ...
        Parameter('threads', kind=int, default=2, override=True, mandatory=False,
                  description='Number of threads to execute.'),
        Parameter('seconds', kind=int, default=10, override=True, mandatory=False,
                  description='Number of seconds.'),
        Parameter('chunks', kind=int, default=10, override=True, mandatory=False,
