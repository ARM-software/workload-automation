...
# If plugins (or modules to document with autodoc) are in another directory,
...
# Add any Sphinx plugin module names here, as strings. They can be plugins
# coming with Sphinx (named 'sphinx.ext.*') or your custom ones.
plugins = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.mathjax', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode']
